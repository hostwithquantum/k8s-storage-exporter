...
import (
	templates "timoni.sh/k8s-storage-exporter/templates"
)

// Define the schema for the user-supplied values.
// At runtime, Timoni injects the supplied values
// and validates them according to the Values schema.
...
timoni: {
	...
	instance: templates.#Instance & {
		...
		// The comprehension copies the values into the config
		// without carrying over the closedness of #Values.
		config: {for k, v in values {(k): v}}
